(this.wordle = this.wordle || {}),
  (this.wordle.bundle = (function (e) {
    ...
    Sa.innerHTML =
      '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n    display: flex;\n    justify-content: space-between;\n    align-items: flex-end;\n  }\n\n  #privacy-policy,\n  #copyright {\n    text-align: left;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Eeee Eeee</div>\n          <div class="description">Eee eeeeeeee eeeee eeee ee eeee ee eeeeeeeeeee eeeeeee</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Eeee Eeeee</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Eeeee Eeeee Eeee</div>\n          <div class="description">Eeee eeeeeeee eeeeee</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Eeeeeeee</div>\n        </div>\n        </section>\n  </div>\n  <div id="footnote">\n    </div>\n';
    var _a = (function (e) {
      r(t, e);
      var a = h(t);
      function t() {
                ...
                if (this.gameStatus === Za && this.canInput) {
                  if (5 !== this.tileIndex)
                    return (
                      ...
                      void this.addToast("Eee eeeeee eeeeeee")
                    );
                  this.evaluateRow();
                }
              },
              ...
              value: function () {
                ...
                this.$game.addEventListener("game-key-press", function (a) {
                    ...
                    function (a) {
                      ...
                      switch (t) {
                        case "hard-mode":
                          return void (n
                            ? e.addToast(
                                "Eeee eeee eee eeee ee eeeeeeee ee eee eeeee ee e eeeee",
                                1500,
                                !0
                              )
                  ...
                  this.shadowRoot
                    ...
                    .addEventListener("click", function (a) {
                      var s = e.$game.querySelector("game-page"),
                        t = document.createTextNode("Eeeeeeee");
                      s.appendChild(t);
                  ...
                  this.shadowRoot
                    ...
                    .addEventListener("click", function (a) {
                      var s = e.$game.querySelector("game-page"),
                        t = document.createTextNode("Eee ee eeee");
                      s.appendChild(t);
  ...
  ***************************************************************************** */
    ...
    var Is = document.createElement("template");
    Is.innerHTML =
      '\n  <div class="countdown">\n    <h1>Eeee EEEEE</h1>\n    <div id="timer">\n      <div class="statistic-container">\n        <div class="statistic timer">\n          <countdown-timer></countdown-timer>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class="share">\n    <button id="share-button">\n      Eeeee <game-icon icon="share"></game-icon>\n    </button>\n  </div>\n';
    var Ms = {
        currentStreak: "Eeeeeee Eeeeee",
        maxStreak: "Eee Eeeeee",
        winPercentage: "Eee %",
        gamesPlayed: "Eeeeee",
        gamesWon: "Eee",
        averageGuesses: "Ee. Eeeeeee",
      },
      Os = (function (e) {
        r(t, e);
        var a = h(t);
    ...
    $s.innerHTML =
      '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>EEEEE</p>\n      <div class="examples">\n        <p><strong>EEEEE</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="e" evaluation="correct" reveal></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="e"></game-tile>\n          </div>\n          <p>Eee eeeee <strong>E</strong> ee ee eee eeee eee ee ee eee eeeeeee eeee.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="e" evaluation="present" reveal></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="e"></game-tile>\n          </div>\n          <p>Eee eeeeee <strong>E</strong> ee ee eee eeee eee ee eee eeeee eeee.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="e" evaluation="absent" reveal></game-tile>\n            <game-tile letter="e"></game-tile>\n          </div>\n          <p>Eee eeeee <strong>E</strong> ee eee ee eee eeee ee eee eeee.</p>\n        </div>\n      </div>\n      <p><strong>E eee EEEEE eeee ee eeeeeeeee eeee eee!<strong></p>\n    </div>\n  </section>\n';
    var Hs = (function (e) {
      r(t, e);
      var a = h(t);
      function t() {
